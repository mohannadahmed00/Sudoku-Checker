...
fun main() {
    ...
    check(
        name = "when enter an empty 4*4 sudoku return true",
        result = isSudokuValid(
            sudokuBoard = listOf(
                listOf("-", "-", "-", "-"),
                listOf("-", "-", "-", "-"),
    ...
    check(
        name = "when enter an uncompleted 4*4 sudoku not contains any repeated numbers in the same row, column, or 3x3 subgrid (box) return true",
        result = isSudokuValid(
            sudokuBoard = listOf(
                listOf("1", "3", "-", "-"),
                listOf("2", "-", "-", "1"),
    ...
    check(
        name = "when enter an uncompleted 4*4 sudoku contains any repeated numbers in the same subgrid (box) return false",
        result = isSudokuValid(
            sudokuBoard = listOf(
                listOf("1", "3", "-", "-"),
                listOf("2", "-", "-", "4"),
